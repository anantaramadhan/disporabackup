...
<body>
    ...
    {{-- section infografis --}}
    <section class="container-xxl d-flex flex-row py-5 gap-4 align-items-center">
        <div class="w-50">
            ...
            <div class="d-flex flex-row gap-4">
                <div class="card p-4 rounded-2 align-items-center w-50">
        ...
        <div class="w-50">
            <svg class="w-100 text-gray-800 dark:text-white" aria-hidden="true" width="748" height="678"
    ...
    <section class="container-xxl d-flex flex-column py-5">
        <div class="d-flex flex-row justify-content-between align-items-center">
            <h1 class="fs-2 text-black d-flex flex-column">Jumlah Pelaku Ekonomi Kreatif <span>per Sektor</span> </h1>
            <div class="d-flex flex-row w-auto gap-4">
