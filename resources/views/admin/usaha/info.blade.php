...
<main id="main" class="main">
  ...
  <section class="section profile">
    <div class="row">
      ...
      <!-- Info Pengaju & Detail Usaha (Satu Card) -->
      <div class="col-xl-12">
        <div class="card">
          <div class="card-body">
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row g-2">
              <div class="col-6"><img src="{{ asset('assets/img/logoekraf.png') }}" class="img-fluid rounded" alt="Foto 1"></div>
              <div class="col-6"><img src="{{ asset('assets/img/logoekraf.png') }}" class="img-fluid rounded" alt="Foto 2"></div>
              <div class="col-12 mt-2"><img src="{{ asset('assets/img/logoekraf.png') }}" class="img-fluid rounded" alt="Foto 3"></div>
            </div>
          </div>
        </div>
      </div>
