                            ...
                            <!-- Form untuk mengedit sektor -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="nama_sektor" class="form-control" id="namasektor"
                                            placeholder="Masukkan nama sektor" required>
                                    </div>

                                    <!-- Deskripsi sektor -->
                                    <div class="col-12 mt-3">
                                        <label for="deskripsisektor" class="form-label">Deskripsi sektor</label>
                                        <textarea name="deskripsi_sektor" class="form-control" id="deskripsisektor" rows="4"
                                            placeholder="Masukkan deskripsi sektor" required></textarea>
                                    </div>

                                    <!-- Foto sektor -->
                                    <div class="col-12 mt-3">
                                        <label for="fotosektor" class="form-label">Foto sektor</label>
                                        <input type="file" name="foto_sektor" class="form-control" id="fotosektor"
                                            accept="image/*">
